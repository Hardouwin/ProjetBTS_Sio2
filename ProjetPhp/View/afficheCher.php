    ...
    <div class="row">
        <div class="col-12">
            <div class="card p-4" style="background-color: #f8f9fa;">
                <h2 class="text-center mb-4">Liste des Chercheurs</h2>
                <?php
                    ...
                    foreach ($string_decode as $medicament) {
                        ...
                        echo '<p><strong>Prenom :</strong> ' . $medicament["prenom"] . '</p>';
                        echo '<p><strong>Mail :</strong> ' . $medicament["mail"] . '</p>';
                        echo '</div>';
                        echo '</div>';
                    }
                    echo '</div>';
                ...
                <br>
                <form id="inscriptionForm" action="index.php?action=INC" method="POST" class="p-4 border rounded bg-white mb-4">
                    ...
                    ?>-->
                    <div class="mb-3">
                        <label for="idA" class="form-label">Id Chercheur :</label>
