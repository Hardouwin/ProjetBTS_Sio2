...
function AddChercheurs()
{
    ...
    $query = "INSERT INTO chercheurs(nom, prenom, mail, date_Ins, idA) VALUES('$nom', '$prenom', '$mail','$date','$idA')";
...
function AddC()
{
    ...
    $query = "INSERT INTO chercheurs(nom, prenom, mail) VALUES('$nom', '$prenom', '$mail')";
